Vue.component('connect-form', {
  ...
  '<div>' +
    ...
    '<div class="mb-6">' +
      ...
      '<input v-model="channel" class="shadow appearance-none border border-red-500 rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" id="channel" type="text" placeholder="channel">' +
